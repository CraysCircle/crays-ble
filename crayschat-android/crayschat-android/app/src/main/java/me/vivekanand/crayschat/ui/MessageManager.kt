...
class MessageManager(private val state: ChatState) {
    ...
    fun addMessage(message: CraysChatMessage) {
    ...
    fun addChannelMessage(channel: String, message: CraysChatMessage) {
    ...
    fun addPrivateMessage(peerID: String, message: CraysChatMessage) {
     ...
     */
    fun generateMessageKey(message: CraysChatMessage): String {
