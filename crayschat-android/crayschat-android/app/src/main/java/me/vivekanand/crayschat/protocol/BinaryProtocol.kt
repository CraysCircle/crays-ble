package me.vivekanand.crayschat.protocol
...
data class CraysChatPacket(
    ...
    companion object {
        fun fromBinaryData(data: ByteArray): CraysChatPacket? {
...
object BinaryProtocol {
    ...
    fun encode(packet: CraysChatPacket): ByteArray? {
        try {
    ...
    fun decode(data: ByteArray): CraysChatPacket? {
        try {
