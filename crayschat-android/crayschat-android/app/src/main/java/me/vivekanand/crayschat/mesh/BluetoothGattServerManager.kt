...
class BluetoothGattServerManager(
        ...
        try {
            ...
            connectionScope.launch {
                try {
                    ...
                    Log.e(TAG, "Error during GATT server startup: ${e.message}")
                    isActive = false
                }
            }
            ...
            Log.e(TAG, "Fatal error during GATT server start: ${e.message}")
            isActive = false
            return false
        }
    }
    ...
    private fun setupGattServer() {
        try {
            if (!permissionManager.hasBluetoothPermissions()) {
                Log.e(TAG, "Missing Bluetooth permissions for GATT server setup")
                return
            }
            ...
            val serverCallback = object : BluetoothGattServerCallback() {
                ...
                override fun onCharacteristicWriteRequest(
                    ...
                    if (characteristic.uuid == CHARACTERISTIC_UUID) {
                        ...
                        val packet = CraysChatPacket.fromBinaryData(value)
                        if (packet != null) {
            ...
            Log.e(TAG, "Error during GATT server setup: ${e.message}")
        }
    }
    ...
    private fun startAdvertising() {
        ...
        if (!isActive) {
            Log.d(TAG, "Server not active, skipping advertising")
            return
        }
        ...
        if (!bluetoothAdapter.isMultipleAdvertisementSupported()) {
            Log.e(TAG, "Multiple advertisement not supported on this device")
            return
        }
        ...
        advertiseCallback = object : AdvertiseCallback() {
            ...
            override fun onStartFailure(errorCode: Int) {
                ...
                when (errorCode) {
                    ...
                    else -> Log.e(TAG, "Unknown advertising failure code: $errorCode")
                }
            }
        }
        ...
        try {
            ...
            Log.d(TAG, "Advertising request sent successfully")
        } catch (e: Exception) {
