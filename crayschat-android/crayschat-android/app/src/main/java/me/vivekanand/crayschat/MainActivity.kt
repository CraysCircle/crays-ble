...
import me.vivekanand.crayschat.mesh.BluetoothMeshService
import me.vivekanand.crayschat.onboarding.BluetoothCheckScreen
import me.vivekanand.crayschat.onboarding.BluetoothStatus
import me.vivekanand.crayschat.onboarding.BluetoothStatusManager
import me.vivekanand.crayschat.onboarding.BatteryOptimizationManager
import me.vivekanand.crayschat.onboarding.BatteryOptimizationScreen
import me.vivekanand.crayschat.onboarding.BatteryOptimizationStatus
import me.vivekanand.crayschat.onboarding.InitializationErrorScreen
import me.vivekanand.crayschat.onboarding.InitializingScreen
import me.vivekanand.crayschat.onboarding.LocationCheckScreen
import me.vivekanand.crayschat.onboarding.LocationStatus
import me.vivekanand.crayschat.onboarding.LocationStatusManager
import me.vivekanand.crayschat.onboarding.OnboardingCoordinator
import me.vivekanand.crayschat.onboarding.OnboardingState
import me.vivekanand.crayschat.onboarding.PermissionExplanationScreen
import me.vivekanand.crayschat.onboarding.PermissionManager
import me.vivekanand.crayschat.ui.ChatScreen
import me.vivekanand.crayschat.ui.ChatViewModel
...
class MainActivity : ComponentActivity() {
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            me.vivekanand.crayschat.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        if (shouldOpenPrivateChat) {
            val peerID = intent.getStringExtra(me.vivekanand.crayschat.ui.NotificationManager.EXTRA_PEER_ID)
            val senderNickname = intent.getStringExtra(me.vivekanand.crayschat.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
