package me.vivekanand.crayschat.noise

import android.content.Context
import android.util.Log
import me.vivekanand.crayschat.identity.SecureIdentityStateManager
import me.vivekanand.crayschat.mesh.PeerFingerprintManager
import me.vivekanand.crayschat.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = me.vivekanand.crayschat.noise.southernstorm.protocol.Noise.createDH("25519")
