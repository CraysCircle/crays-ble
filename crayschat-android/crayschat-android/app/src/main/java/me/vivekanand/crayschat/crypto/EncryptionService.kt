package me.vivekanand.crayschat.crypto

import android.content.Context
import android.util.Log
import me.vivekanand.crayschat.noise.NoiseEncryptionService
 ...
 * 
 * This is the main interface for all encryption/decryption operations in crayschat.
...
class EncryptionService(private val context: Context) {
    ...
    fun clearPersistentIdentity() {
        ...
        try {
            val prefs = context.getSharedPreferences("crayschat_crypto", Context.MODE_PRIVATE)
