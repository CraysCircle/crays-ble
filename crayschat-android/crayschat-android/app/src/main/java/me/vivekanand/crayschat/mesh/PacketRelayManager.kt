 ...
 * 
 * This class handles all relay decisions and logic for crayschat packets.
...
class PacketRelayManager(private val myPeerID: String) {
     ...
     */
    internal fun isPacketAddressedToMe(packet: CraysChatPacket): Boolean {
     ...
     */
    private fun shouldRelayPacket(packet: CraysChatPacket, fromPeerID: String): Boolean {
