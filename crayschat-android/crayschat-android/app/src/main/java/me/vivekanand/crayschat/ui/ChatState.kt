...
class ChatState {
    ...
    private val _messages = MutableLiveData<List<CraysChatMessage>>(emptyList())
    val messages: LiveData<List<CraysChatMessage>> = _messages
    ...
    // Private chats
    private val _privateChats = MutableLiveData<Map<String, List<CraysChatMessage>>>(emptyMap())
    val privateChats: LiveData<Map<String, List<CraysChatMessage>>> = _privateChats
    ...
    private val _channelMessages = MutableLiveData<Map<String, List<CraysChatMessage>>>(emptyMap())
    val channelMessages: LiveData<Map<String, List<CraysChatMessage>>> = _channelMessages
    ...
    fun setMessages(messages: List<CraysChatMessage>) {
    ...
    fun setPrivateChats(chats: Map<String, List<CraysChatMessage>>) {
    ...
    fun setChannelMessages(messages: Map<String, List<CraysChatMessage>>) {
