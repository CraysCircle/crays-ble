package me.vivekanand.crayschat.mesh

import android.content.Context
import android.util.Log
import me.vivekanand.crayschat.crypto.EncryptionService
import me.vivekanand.crayschat.protocol.MessagePadding
import me.vivekanand.crayschat.model.CraysChatMessage
import me.vivekanand.crayschat.model.HandshakeRequest
import me.vivekanand.crayschat.model.RoutedPacket
import me.vivekanand.crayschat.model.DeliveryAck
import me.vivekanand.crayschat.model.ReadReceipt
import me.vivekanand.crayschat.model.NoiseIdentityAnnouncement
import me.vivekanand.crayschat.protocol.CraysChatPacket
import me.vivekanand.crayschat.protocol.MessageType
import me.vivekanand.crayschat.protocol.SpecialRecipients
import me.vivekanand.crayschat.util.toHexString
    ...
    private fun setupDelegates() {
        ...
        securityManager.delegate = object : SecurityManagerDelegate {
            ...
            override fun sendHandshakeResponse(peerID: String, response: ByteArray) {
                ...
                val responsePacket = CraysChatPacket(
                    version = 1u,
        ...
        storeForwardManager.delegate = object : StoreForwardManagerDelegate {
            ...
            override fun sendPacket(packet: CraysChatPacket) {
        ...
        messageHandler.delegate = object : MessageHandlerDelegate {
            ...
            override fun verifySignature(packet: CraysChatPacket, peerID: String): Boolean {
            ...
            override fun sendDeliveryAck(message: CraysChatMessage, senderPeerID: String) {
                this@BluetoothMeshService.sendDeliveryAck(message, senderPeerID)
            }
            
            // Callbacks
            override fun onMessageReceived(message: CraysChatMessage) {
        ...
        packetProcessor.delegate = object : PacketProcessorDelegate {
            override fun validatePacketSecurity(packet: CraysChatPacket, peerID: String): Boolean {
            ...
            override fun handleFragment(packet: CraysChatPacket): CraysChatPacket? {
...
//            }
        ...
        connectionManager.delegate = object : BluetoothConnectionManagerDelegate {
            override fun onPacketReceived(packet: CraysChatPacket, peerID: String, device: android.bluetooth.BluetoothDevice?) {
    ...
    fun sendPrivateMessage(content: String, recipientPeerID: String, recipientNickname: String, messageID: String? = null) {
        ...
        message.toBinaryPayload()?.let { messageData ->
            try {
                ...
                val innerPacket = CraysChatPacket(
                    type = MessageType.MESSAGE.value,
                    senderID = hexStringToByteArray(myPeerID),
     ...
     */
    fun sendDeliveryAck(message: CraysChatMessage, senderPeerID: String) {
        val nickname = delegate?.getNickname() ?: myPeerID
        val ack = DeliveryAck(
    ...
    /**
     * Encrypt a CraysChatPacket and broadcast it as a NOISE_ENCRYPTED message
     * This is the correct protocol implementation - encrypt the entire packet, not just the payload
     */
    private fun encryptAndBroadcastNoisePacket(innerPacket: CraysChatPacket, recipientPeerID: String) {
        serviceScope.launch {
            try {
                ...
                if (encryptedPayload != null) {
                    ...
                    val outerPacket = CraysChatPacket(
                        type = MessageType.NOISE_ENCRYPTED.value,
                        senderID = hexStringToByteArray(myPeerID),
                        recipientID = hexStringToByteArray(recipientPeerID),
                        timestamp = System.currentTimeMillis().toULong(),
    ...
    fun sendBroadcastAnnounce() {
        ...
        serviceScope.launch {
            ...
            val announcePacket = CraysChatPacket(
     ...
     */
    fun getSessionState(peerID: String): me.vivekanand.crayschat.noise.NoiseSession.NoiseSessionState {
...
interface BluetoothMeshDelegate {
    fun didReceiveMessage(message: CraysChatMessage)
