...
class FragmentManager {
     ...
     */
    fun createFragments(packet: CraysChatPacket): List<CraysChatPacket> {
        ...
        val fragments = mutableListOf<CraysChatPacket>()
        ...
        for (i in 0 until totalFragments) {
            ...
            val fragmentPacket = CraysChatPacket(
     ...
     */
    fun handleFragment(packet: CraysChatPacket): CraysChatPacket? {
        ...
        try {
            ...
            if (incomingFragments[fragmentID]?.size == total) {
                ...
                val reassembledPacket = CraysChatPacket.fromBinaryData(reassembledData.toByteArray())
...
interface FragmentManagerDelegate {
    fun onPacketReassembled(packet: CraysChatPacket)
}
