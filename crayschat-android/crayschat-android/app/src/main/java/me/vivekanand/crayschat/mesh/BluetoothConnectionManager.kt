...
class BluetoothConnectionManager(
    ...
    private val componentDelegate = object : BluetoothConnectionManagerDelegate {
        override fun onPacketReceived(packet: CraysChatPacket, peerID: String, device: BluetoothDevice?) {
...
interface BluetoothConnectionManagerDelegate {
    fun onPacketReceived(packet: CraysChatPacket, peerID: String, device: BluetoothDevice?)
