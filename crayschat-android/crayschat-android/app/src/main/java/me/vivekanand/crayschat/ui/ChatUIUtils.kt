...
fun getRSSIColor(rssi: Int): Color {
    return when {
        rssi >= -50 -> Color(0xFF008000) // Darker Green - good contrast
        rssi >= -60 -> Color(0xFF669900) // Olive-Green - still positive, more visible
        rssi >= -70 -> Color(0xFFCCAA00) // Dark Mustard Yellow - more readable on white
