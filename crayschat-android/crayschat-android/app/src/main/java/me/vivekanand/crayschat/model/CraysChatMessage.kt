...
/**
 * Crays Circle Message - 100% compatible with iOS version
 */
@Parcelize
data class CraysChatMessage(
    ...
    companion object {
         ...
         */
        fun fromBinaryPayload(data: ByteArray): CraysChatMessage? {
            try {
